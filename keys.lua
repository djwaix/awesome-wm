...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, shiftkey }, "r", function() awful.spawn(file1) end,
    ...
    awful.key({ modkey, ctrlkey }, "=", function() awful.tag.incmwfact( 0.05)          end,
        {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey, ctrlkey }, "-", function() awful.tag.incmwfact(-0.05)          end,
        {description = "decrease master width factor", group = "layout"}),
    ...
    -- Menubar
    awful.key({ modkey }, "r", function() awful.spawn.with_shell("rofi -show combi -combi-modi \"drun,run\"") end,
